...
public class AndroidBarcodeQrExample extends Activity implements View.OnClickListener {
	...
	public void onClick(View v) {
		switch (v.getId()){
			case R.id.scan:
				Intent i = new Intent(AndroidBarcodeQrExample.this, scanner_activity.class);
				startActivity(i);
				finish();
				break;
		}
